...
//				}
    ...
    private void testData1(){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                EBikeTravelData eBikeTravelData= EBikeTravelData.getInstance(HomeUiActivity.this);
                int i=0;
                while (isTest) {
                    Random random = new Random();
                    EBikeTravelData.getInstance(HomeUiActivity.this);
                    eBikeTravelData.avgSpeed = random.nextInt(30)+5;
                    eBikeTravelData.insSpeed = random.nextInt(6)+eBikeTravelData.avgSpeed;
                    eBikeTravelData.spendTime = 80+i;
                    eBikeTravelData.distance = 5+i;
                    eBikeTravelData.calorie = 60;
                    eBikeTravelData.cadence = 30;
                    eBikeTravelData.altitude = 3;
                    eBikeTravelData.frontLed = 1;
                    eBikeTravelData.sportMode = 2;
                    eBikeTravelData.assisMode = 2;
                    eBikeTravelData.batteryAh = 50;
                    eBikeTravelData.gear = 1;
                    eBikeTravelData.batteryResidueCapacity = 60;
                    eBikeTravelData.remaindTravelCapacity = 35;
