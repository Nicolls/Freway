...
//		data=simulateData(data);// 模拟数据
		if (data != null && data.length >= 2) {
			...
			remaindTravelCapacity = RemainMiCaculate.getInstance(context).remain_mileage_proc((int)cal_tempDistance, (int) (cal_tempDistance * (WHEEL_VALUE / 1000f)), gearTemp, batteryAh, batteryResidueCapacity);//batteryResidueCapacity * batteryAh * 12 / 780;// 公里（千米）
